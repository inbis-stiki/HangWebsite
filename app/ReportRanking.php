...
class ReportRanking
{
    ...
    public function generate_ranking_asmen($datas, $yearMonth)
    {
        ...
        $firstRow = 7;
        $lastRow = $rowStart - 1;
        $ObjSheet->setCellValue('D' . ($rowStart + 1), '=ROUND(AVERAGE(D' . $firstRow . ':D' . $lastRow . '), 2)')->getStyle('D' . ($rowStart + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('E' . ($rowStart + 1), '=ROUND(AVERAGE(E' . $firstRow . ':E' . $lastRow . '), 2)')->getStyle('E' . ($rowStart + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('F' . ($rowStart + 1), '=ROUND(AVERAGE(F' . $firstRow . ':F' . $lastRow . '), 2)')->getStyle('F' . ($rowStart + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('G' . ($rowStart + 1), '=ROUND(AVERAGE(G' . $firstRow . ':G' . $lastRow . '), 2)')->getStyle('G' . ($rowStart + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('H' . ($rowStart + 1), '=ROUND(AVERAGE(H' . $firstRow . ':H' . $lastRow . '), 2)')->getStyle('H' . ($rowStart + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('I' . ($rowStart + 1), '=ROUND(AVERAGE(I' . $firstRow . ':I' . $lastRow . '), 2)')->getStyle('I' . ($rowStart + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('J' . ($rowStart + 1), '=ROUND(AVERAGE(J' . $firstRow . ':J' . $lastRow . '), 2)')->getStyle('J' . ($rowStart + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('K' . ($rowStart + 1), '=ROUND(AVERAGE(K' . $firstRow . ':K' . $lastRow . '), 2)')->getStyle('K' . ($rowStart + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('L' . ($rowStart + 1), '=ROUND(AVERAGE(L' . $firstRow . ':L' . $lastRow . '), 2)')->getStyle('L' . ($rowStart + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('M' . ($rowStart + 1), '=ROUND(AVERAGE(M' . $firstRow . ':M' . $lastRow . '), 2)')->getStyle('M' . ($rowStart + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->getStyle('N' . ($rowStart + 1))->applyFromArray($this->styling_title_template('FF000000', 'FFFFFFFF'))->getAlignment()->setWrapText(true);
        ...
        $lastRow = $rowStart3 - 1;
        $ObjSheet->setCellValue('D' . ($rowStart3 + 1), '=ROUND(AVERAGE(D' . $firstRow . ':D' . $lastRow . '), 2)')->getStyle('D' . ($rowStart3 + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('E' . ($rowStart3 + 1), '=ROUND(AVERAGE(E' . $firstRow . ':E' . $lastRow . '), 2)')->getStyle('E' . ($rowStart3 + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('F' . ($rowStart3 + 1), '=ROUND(AVERAGE(F' . $firstRow . ':F' . $lastRow . '), 2)')->getStyle('F' . ($rowStart3 + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('G' . ($rowStart3 + 1), '=ROUND(AVERAGE(G' . $firstRow . ':G' . $lastRow . '), 2)')->getStyle('G' . ($rowStart3 + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('H' . ($rowStart3 + 1), '=ROUND(AVERAGE(H' . $firstRow . ':H' . $lastRow . '), 2)')->getStyle('H' . ($rowStart3 + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('I' . ($rowStart3 + 1), '=ROUND(AVERAGE(I' . $firstRow . ':I' . $lastRow . '), 2)')->getStyle('I' . ($rowStart3 + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('J' . ($rowStart3 + 1), '=ROUND(AVERAGE(J' . $firstRow . ':J' . $lastRow . '), 2)')->getStyle('J' . ($rowStart3 + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('K' . ($rowStart3 + 1), '=ROUND(AVERAGE(K' . $firstRow . ':K' . $lastRow . '), 2)')->getStyle('K' . ($rowStart3 + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('L' . ($rowStart3 + 1), '=ROUND(AVERAGE(L' . $firstRow . ':L' . $lastRow . '), 2)')->getStyle('L' . ($rowStart3 + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('M' . ($rowStart3 + 1), '=ROUND(AVERAGE(M' . $firstRow . ':M' . $lastRow . '), 2)')->getStyle('M' . ($rowStart3 + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('N' . ($rowStart3 + 1), '=ROUND(AVERAGE(N' . $firstRow . ':N' . $lastRow . '), 2)')->getStyle('N' . ($rowStart3 + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('O' . ($rowStart3 + 1), '=ROUND(AVERAGE(O' . $firstRow . ':O' . $lastRow . '), 2)')->getStyle('O' . ($rowStart3 + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('P' . ($rowStart3 + 1), '=ROUND(AVERAGE(P' . $firstRow . ':P' . $lastRow . '), 2)')->getStyle('P' . ($rowStart3 + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('Q' . ($rowStart3 + 1), '=ROUND(AVERAGE(Q' . $firstRow . ':Q' . $lastRow . '), 2)')->getStyle('Q' . ($rowStart3 + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('R' . ($rowStart3 + 1), '=ROUND(AVERAGE(R' . $firstRow . ':R' . $lastRow . '), 2)')->getStyle('R' . ($rowStart3 + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->setCellValue('S' . ($rowStart3 + 1), '=ROUND(AVERAGE(S' . $firstRow . ':S' . $lastRow . '), 2)')->getStyle('S' . ($rowStart3 + 1))->applyFromArray($this->styling_content_template('FF00FFFF', 'FF000000'))->getAlignment()->setWrapText(true);
        $ObjSheet->getStyle('T' . ($rowStart3 + 1))->applyFromArray($this->styling_title_template('FF000000', 'FFFFFFFF'))->getAlignment()->setWrapText(true);
