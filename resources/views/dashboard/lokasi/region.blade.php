...
<div class="flex flex-row justify-between items-center">
    ...
    <button onclick="modal('modalTambah')" class="p-3 bg-orange-400 text-white flex flex-row items-center space-x-3 rounded-lg ">
        ...
        <span class="text-sm">Tambah Region</span>
    </button>
</div>
    ...
    <div class="p-10">
        <div class="grid grid-cols-1 space-y-8">
            ...
            <div class="col-span-1 grid grid-cols-2">
                ...
                <div class="col-span-1 my-auto">
                    <input type="text" name="Region" id="" value="" class="box-border h-6 border-solid border border-gray-200 rounded py-4 px-4 focus:outline-orange-500 focus:ring-0 focus:outline-2 focus:border-gray-200 focus:outline-offset-2" placeholder="Input Nama">
                </div>
            </div>
            <div class="col-span-1 grid grid-cols-2">
                <div class="col-span-1 my-auto">
