...
<body class="grid grid-cols-9 bg-gray-100">
    <aside class="self-start sticky top-0 col-span-2 px-5 py-9 border-r bg-white border-gray-200 hidden md:block">
            ...
            <div class="space-y-4">
                ...
                <div class=" px-4 py-3 space-y-5">
                    ...
                    <div class="flex flex-row space-x-7">
                        <div class="w-6 h-6"></div>
                        <div class="px-4">
                            <span class="text-orange-500">Pasar</span>
                        </div>
                    </div>
                </div>
                <a href="#" class="flex flex-row rounded-lg px-4 py-3 space-x-7 ">
