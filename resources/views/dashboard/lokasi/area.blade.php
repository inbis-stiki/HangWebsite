    ...
    <div class="p-10">
        <div class="grid grid-cols-1 space-y-8">
            <div class="col-span-1">
                <span class="text-2xl font-semibold">Tambah Region</span>
            </div>
            ...
            <div class="col-span-1 grid grid-cols-2">
                ...
                <div class="col-span-1 my-auto">
                    <select name="lokasi" id="lokasi" class="form-select text-gray-400 box-border w-full h-9 text-sm border-solid border border-gray-200 rounded focus:outline-orange-500 focus:ring-0 focus:outline-2 focus:border-gray-200 focus:outline-offset-2">
            ...
            <div class="col-span-1 grid grid-cols-2">
                <div class="col-span-1 my-auto">
                    <span class="font-medium">Nama Area</span>
                </div>
                <div class="col-span-1 my-auto">
                    <input type="text" name="area" id="area" value="" class="box-border text-gray-400 text-sm h-9 border-solid border border-gray-200 rounded  focus:outline-orange-500 focus:ring-0 focus:outline-2 focus:border-gray-200 focus:outline-offset-2" placeholder="Input Nama">
                </div>
            </div>
            <div class="col-span-1 grid grid-cols-2">
                <div class="col-span-1 my-auto">
