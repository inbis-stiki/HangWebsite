            ...
            <div class="mx-auto px-20 mt-20">
                ...
                <div class="mt-3 space-y-4">
                    <div class="flex flex-col">
                        ...
                        <input type="text" name="username" id="input_username" class="box-border h-12 mt-2 border-solid border border-gray-200 rounded py-4 px-6 focus:outline-orange-500 focus:outline-2 focus:outline-offset-4" placeholder="Username" required>
                    </div>
                    <div class="flex flex-col">
                        <span class="font-normal text-xs">Password</span>
                        <input type="password" name="password" id="input_password" class="box-border h-12 mt-2 border-solid border border-gray-200 rounded py-4 px-6 focus:outline-orange-500 focus:outline-2 focus:outline-offset-4" placeholder="Password" required>
                    </div>
                </div>
                @if (session('err_msg'))
                    <br>
